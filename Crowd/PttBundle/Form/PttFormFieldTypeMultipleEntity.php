...
class PttFormFieldTypeMultipleEntity extends PttFormFieldType
{
	public function field() {
		...
		$htmlField .= '</div></div><div class="related-multiple-entities"><ul class="multi-sortable"><li class="head"><span class="handle">Orden</span><span class="hidden-xs">Material - Cantidad</span><span class="actions"></span></li>';
