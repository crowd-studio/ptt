...
class PttFormFieldTypeUpload extends PttFormFieldType
{
	public function field()
	{
		...
		// DIV 1: UPLOAD BUTTON
		$html .= '<div class="upload-file-container col-sm-12">';
		...
		$html .= '<div class="load-mode col-sm-12">';
			...
			$html .= '</div>';	
			$html .= '<div class="col-sm-3"><a href="" class="btn btn-cancel" style="height: 30px;padding: 3px 15px;border-color: #fd4343;">'.$this->pttTrans->trans('cancel').'</a></div>';
		$html .= '</div>';
		// DIV 3: RESULT
		$html .= '<div class="result col-sm-12">';
		...
		$html .= '<div class="view-mode col-sm-12" style="text-align:right;">';
